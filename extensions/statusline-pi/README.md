...
- Set `STATUSLINE_PI_CONTEXT=used` to show consumed context tokens and percentage instead of the default remaining context.
...
pi install npm:statusline-pi@1.3.1   # pin version
