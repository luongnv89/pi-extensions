...
EXTENSIONS=(9router-pi advisor-pi agy-pi cache-warm claude-code-pi cursor-pi grok-pi model-debugger opencode-pi statusline-pi subagents-pi timestamp-pi)
